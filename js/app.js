(() => {
    ...
    function generatePagination(totalPages, currentPage) {
        ...
        if (paginationContainer) {
            ...
            if (totalPages > MAX_VISIBLE_BUTTONS) if (currentPage <= BUTTONS_ON_EACH_SIDE + 1) endPage = MAX_VISIBLE_BUTTONS - 1; else if (currentPage >= totalPages - BUTTONS_ON_EACH_SIDE) startPage = totalPages - MAX_VISIBLE_BUTTONS + 3; else {
                startPage = currentPage - BUTTONS_ON_EACH_SIDE;
                endPage = currentPage + BUTTONS_ON_EACH_SIDE - 2;
            }
            if (startPage > 1) {
